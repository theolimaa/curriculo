...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!payment) return NextResponse.json({ error: "Sessão não encontrada" }, { status: 404 });
...
Formato: {"nome":"","telefone":"","email":"","cidade":"","objetivo":"string profissional 2-3 linhas","experiencias":[{"empresa":"","cargo":"","periodo":"","descricao":""}],"formacao":[{"instituicao":"","curso":"","ano":""}],"habilidades":[{"nome":"","nivel":"basico|intermediario|avancado"}]}`;
